...
const EXPERIENCES = [
  { label: "Victoria Falls", href: "/tours#victoria-falls-experience" },
  { label: "Safari", href: "/tours#hwange-safari" },
  { label: "Zambezi", href: "/tours#zambezi-sunset-cruise" },
      ...
      <div className="footer-top">
        <div className="footer-brand">
          <div className="logoWrapper">
            ...
            <img src={IMAGES.logo} alt="Family Travel and Tours logo" className="footer-logo-img" />
            <span className="footer-logo-text">{COMPANY.name}</span>
          </div>
          <p className="footer-tagline">{COMPANY.tagline}</p>
          <div className="footer-contact-row">
            <a href={`https://wa.me/${COMPANY.whatsapp[0]}?text=${encodeURIComponent(COMPANY.waMessage)}`} target="_blank" rel="noopener noreferrer">
              {COMPANY.phones[0]}
            </a>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-left">
          <div className="footer-social">
            ...
            <a href={`https://wa.me/${COMPANY.whatsapp[0]}?text=${encodeURIComponent(COMPANY.waMessage)}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
